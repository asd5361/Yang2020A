package com.example.a08openweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    //현재 날씨
    // xml
    String currenturl = "https://api.openweathermap.org/data/2.5/weather?&mode=xml&units=metric&appid=8b869548f736ce7535640ae09144e6fb";
    String forecasturl = "https://api.openweathermap.org/data/2.5/forecast?&mode=json&units=metric&appid=8b869548f736ce7535640ae09144e6fb";
...
//AndroidManifest.xml에서 통신을 받아오기 위해 한줄 적어줘야됨
    ...
    class ReqeustTaskcurrent extends AsyncTask<Integer,Integer,Integer> {
        ...
        protected Integer doInBackground(Integer... integers) {
            weatherdata = getHTTPdate(sourceurl);
            return null;
        }
    }
    ...
    class ReqeustTaskforecast extends AsyncTask<Integer,Integer,Integer> {
        ...
        @Override
        protected Integer doInBackground(Integer... integers) {
            weatherdataforecast = getHTTPdate(sourceurlforecast);
            return null;
        }
    }
